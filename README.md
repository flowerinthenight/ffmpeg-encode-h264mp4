...
You need to copy ffmpeg's [bin](./ffmpeg-latest-win64-shared/bin/) files to the output directory of the C# project. This repo is tested using Debug|x64 so the bin files are also included there.
