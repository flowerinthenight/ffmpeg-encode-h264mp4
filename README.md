...
You need to copy ffmpeg's [bin](./ffmpeg-latest-win64-shared/bin/) files (`*.dll`) to the output directory of the C# project. This project is tested using [Debug|x64](./H264MP4Encode/bin/x64/Debug/) so the bin files are already included there.
